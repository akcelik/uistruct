...
@Component({
  ...
  styles: [
    `
    .strct-donut { display: inline-block; }
    .strct-donut__wrap { position: relative; }
    .strct-donut__track { stroke: var(--bg-3); }
    .strct-donut__center {
      position: absolute; inset: 0; display: flex; flex-direction: column;
      align-items: center; justify-content: center; pointer-events: none;
    }
    .strct-donut__value { font-size: 20px; font-weight: 600; color: var(--t1); line-height: 1; }
    .strct-donut__label { font-size: 11px; color: var(--t2); margin-top: 2px; }
    `,
  ],
})
