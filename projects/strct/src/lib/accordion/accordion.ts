...
@Component({
  ...
  styles: [
    ...
    .strct-acc {
      ...
      border: 1px solid var(--b2); border-radius: 7px; overflow: hidden;
    }
    .strct-acc__head {
    ...
    .strct-acc__head:hover { background: var(--bg-3); }
    .strct-acc__chevron {
      display: inline-flex; color: var(--t3); transition: transform .16s ease;
    }
    .strct-acc__chevron--open { transform: rotate(90deg); color: var(--acc); }
    .strct-acc__title { flex: 1; }
    .strct-acc__body {
      padding: 4px 14px 14px 32px; color: var(--t2); font-size: 13px;
