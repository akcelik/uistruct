...
export const MOCK_DATA: Record<string, DcObject[]> = {
  compute: [
    ...
    },
    {
      ...
      type: 'Cluster',
      status: 'running',
      description: 'HA-enabled DRS cluster spanning 8 hosts.',
      specs: {
        Hosts: '8',
        'Total vCPUs': '384',
        'Total RAM': '4 TB',
  ...
  network: [
    ...
    {
      id: 'vsw-prod-01',
      name: 'vSwitch-Prod-01',
      type: 'Virtual Switch',
      status: 'running',
      description: 'Distributed virtual switch for production VLANs.',
      specs: {
        Uplinks: '4× 25 Gbps',
        MTU: '9000',
        VLANs: '12',
    ...
    },
    {
      ...
      type: 'Firewall',
      status: 'running',
      description: 'NSX-T Tier-0 edge firewall.',
      specs: {
        Rules: '340',
        Throughput: '10 Gbps',
        HA: 'Active/Standby',
  ...
  storage: [
    DEFAULT_APPLIANCE,
    {
      ...
      type: 'Datastore',
      status: 'running',
      description: 'All-flash vSAN datastore — performance tier.',
      specs: {
        Capacity: '10 TB',
        Free: '3.2 TB',
        Type: 'vSAN',
